      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              ...
              <div className="bg-theme-cart rounded text-white font-medium lg:textxs w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center">
                {cartQuantity}
              </div>
              <button
                type="button"
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              type="button"
              className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-center justify-items-center cursor-pointer"
