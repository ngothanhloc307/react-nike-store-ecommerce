...
const FlexContent = ({
  ifExists,
  endpoint: { title, heading, subtitle, text, img, btn, url },
}) => {
  return (
    <>
      <div
      ...
      >
        <div className="max w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-3xl font-bold text-slate-900 filter drop-shadow-lg">
            {title}
          </h1>
          ...
          <img
            ...
            className={`w-auto object-fill transitions-theme ${
              ifExists
                ...
                : "h-72 lg:h-64 md:h-60 sm:h-48 xms:h-40 rotate-[19deg] hover:rotate-1"
            }`}
          />
        </div>
      </div>
